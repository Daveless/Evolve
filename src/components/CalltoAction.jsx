...
const CalltoAction = () => {
  return (
    <div className={style.calltoAction}>
        <ExternalLinkButton link="https://api.whatsapp.com/send?phone=593984463104&text=Hello!" buttonColor={buttonStyle.secondaryColor} text='Contactanos' opensInAnotherTab='_blank'></ExternalLinkButton>
